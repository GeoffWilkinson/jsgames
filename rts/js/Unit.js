...
function unitClass () {
	...
	this.drawSelectionBox = function() {
		...
		colouredOutlineRectCornerToCorner(this.x - UNIT_SELECT_DIM_HALF, this.y - UNIT_SELECT_DIM_HALF, this.x + UNIT_SELECT_DIM_HALF, this.y + UNIT_SELECT_DIM_HALF, 'green');
	...
	this.draw = function() {
		...
		if(this.isDead == false) {
			colourCircle(this.x, this.y, UNIT_PLACEHOLDER_RADIUS, this.unitColour);
		}
